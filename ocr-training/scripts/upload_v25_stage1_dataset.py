...
def main():
    ds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "output", "v25_stage1_dataset"))
    print(f"📦 Thư mục Dataset: {ds_dir}")
    ...
    print("\n🚀 Bắt đầu tạo mới Dataset trên Kaggle: gustavnguyen/cham-ocr-v25-stage1-checkpoint...")
    t0 = time.time()
    try:
